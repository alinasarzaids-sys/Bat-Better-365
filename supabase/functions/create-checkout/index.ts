...
serve(async (req) => {
  ...
  try {
    ...
    const stripe = new Stripe(Deno.env.get("Stripe_key") || "", { apiVersion: "2025-08-27.basil" });
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "subscription",
      success_url: `cricketpro://subscription/success`,
      cancel_url: `cricketpro://subscription/cancel`,
    });
